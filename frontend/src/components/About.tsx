        ...
        <div className='flex flex-col gap-3 w-1/2 items-start justify-start h-64'>
          <div className='flex flex-col text-3xl font-bold gap-3'>
            ...
            <p className='text-lg'>
              ...
              JavaScript engineer. I spend my days (and often nights) writing
              lines of code with PROJECTS and turning zeroes and ones into
              immersive, interactive experiences.
            </p>
          </div>
          <button className='contact' onClick={about}>
            contact me
          </button>
        </div>
        <div className='flex justify-center items-center w-1/2 ml-20'>
          <div className='rounded-full h-80 w-80 bg-black relative z-10'>
            <div className='transparent absolute z-20'>
              <Profile />
            </div>
          </div>
        </div>
